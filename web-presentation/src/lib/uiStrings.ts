...
export function getUiStrings(lang: UiLang): UiStrings {
  if (lang === "en") {
    return {
      ...
      day01SlidesShortcut: "Text Analysis (S10)",
      day01SlidesShortcutTitle:
        "Jump to Week 3 Session 3 — POS, NER, and mini project (Section 10)",
      deckScopeLabel: "Deck track",
      deckScopeAll: "Full deck (S1–S16)",
      deckScopeDay1: "Week 3 — Text analysis (S10 only)",
      deckScopeWeek1: "Week 1 — ML core (S1–S6)",
      deckScopeWeek2: "Week 2 — Deep learning (S7)",
      deckScopeWeek3: "Week 3 — NLP (S8→S9→S10→S11→S12→S13)",
      deckScopeWeek4: "Week 4 — GenAI + RAG + MLOps (S14–S16)",
      nav: {
  ...
  return {
    ...
    day01SlidesShortcut: "تحليل نصي (S10)",
    day01SlidesShortcutTitle:
      "الانتقال للجلسة 3 — POS وNER والمشروع المصغّر (القسم 10)",
    deckScopeLabel: "مسار العرض",
    deckScopeAll: "العرض الكامل (S1–S16)",
    deckScopeDay1: "الأسبوع 3 — تحليل نصي (S10 فقط)",
    deckScopeWeek1: "الأسبوع 1 — ML (S1–S6)",
    deckScopeWeek2: "الأسبوع 2 — تعلم عميق (S7)",
    deckScopeWeek3: "الأسبوع 3 — NLP (S8→S9→S10→S11→S12→S13)",
    deckScopeWeek4: "الأسبوع 4 — GenAI + RAG + MLOps (S14–S16)",
    nav: {
