...
export function getUiStrings(lang: UiLang): UiStrings {
  if (lang === "en") {
    return {
      ...
      day01SlidesShortcut: "Text Analysis (S14)",
      day01SlidesShortcutTitle:
        "Jump to Week 3 Session 3 — POS, NER, and mini project (Section 14)",
      deckScopeLabel: "Deck track",
      deckScopeAll: "Full deck (S1–S16)",
      deckScopeDay1: "Week 3 — Text analysis (S14 only)",
      deckScopeWeek1: "Week 1 — ML core (S1–S6)",
      deckScopeWeek2: "Week 2 — Deep learning (S7)",
      deckScopeWeek3: "Week 3 — NLP (S8→S9→S14→S10→S11→S12)",
  ...
  return {
    ...
    day01SlidesShortcut: "تحليل نصي (S14)",
    day01SlidesShortcutTitle:
      "الانتقال للجلسة 3 — POS وNER والمشروع المصغّر (القسم 14)",
    deckScopeLabel: "مسار العرض",
    deckScopeAll: "العرض الكامل (S1–S16)",
    deckScopeDay1: "الأسبوع 3 — تحليل نصي (S14 فقط)",
    deckScopeWeek1: "الأسبوع 1 — ML (S1–S6)",
    deckScopeWeek2: "الأسبوع 2 — تعلم عميق (S7)",
    deckScopeWeek3: "الأسبوع 3 — NLP (S8→S9→S14→S10→S11→S12)",
