...
export const SECTION_KEY_TOPICS: Record<number, string[]> = {
  ...
  10: ["N-gram LMs", "Perplexity", "Smoothing", "Neural LMs intro"],
  11: ["Word embeddings", "Contextual vectors", "RNNs", "Attention preview"],
  12: ["Seq2Seq", "Machine translation", "BLEU / ROUGE", "Beam search"],
  13: ["Transformers", "BERT & GPT", "Fine-tuning", "LLM scaling"],
  14: ["End-to-end NLP lab", "Tokenization practice", "NER & POS", "Text analytics mini-project"],
