...
export const slides = [
  {
    ...
    "columns": [
      ...
      },
      {
        ...
        "bullets": [
          {
            "text": "Calculate performance metrics",
            "icon": "metric"
          },
          {
            "text": "Make a final prediction",
            "icon": "target"
          }
        ]
      }
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Training Set: Data used by the model to learn patterns.",
        "icon": "train"
      },
      {
    ...
    "titleIcon": "train",
    "conceptAnimation": "train-test-split"
  },
  {
    ...
    "bullets": [
      {
        "text": "It prevents large-value features from dominating smaller-value features.",
        "icon": "feature"
      },
      {
        "text": "It improves performance for distance-based and gradient-based algorithms (e.g., KNN, SVM, Gradient Descent).",
        "icon": "svm"
      },
      {
        "text": "It helps training converge faster.",
        "icon": "train"
      }
    ],
    "table": {
    ...
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Useful for models that depend on distances or absolute magnitudes.",
            "icon": "model"
          },
          {
            "text": "Common choice for algorithms such as KNN and K-Means.",
            "icon": "scaling"
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "text": "mu = mean of the feature, sigma = standard deviation of the feature.",
            "icon": "feature"
          },
          {
            "text": "Preferred when features are close to a Gaussian distribution.",
            "icon": "feature"
          },
          {
            "text": "Works well with Logistic Regression, SVM, and Linear Regression.",
            "icon": "regression"
          }
        ]
      }
    ...
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Typical method: Min-Max Scaling.",
            "icon": "scaling"
          },
          {
            "text": "Good for distance-based models where magnitude differences strongly affect results.",
            "icon": "model"
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "text": "It keeps the data centered around 0 and scales variability to 1.",
            "icon": "scaling"
          },
          {
            "text": "Often preferred for linear models and optimization-based algorithms.",
            "icon": "regression"
          }
        ]
      }
  ...
  },
  {
    ...
    "bullets": [
      ...
      {
        "text": "Standard deviation: \\(\\sigma = 28.28\\)",
        "icon": "scaling"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Use Ordinal Encoding only when categories have a true order.",
        "icon": "encoding"
      },
      {
        "text": "Step 1: Identify the correct category order.",
        "icon": "encoding"
      },
      {
        "text": "Step 2: Assign an integer to each level based on that order.",
        "icon": "encoding"
      },
      {
        "text": "Step 3: Replace the original text values with encoded numbers.",
        "icon": "encoding"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Use One-Hot Encoding for nominal categories (no natural order).",
        "icon": "encoding"
      },
      {
        "text": "Step 1: List all unique categories.",
        "icon": "encoding"
      },
      {
        "text": "Step 2: Create one column for each category.",
        "icon": "encoding"
      },
      {
        "text": "Step 3: Put 1 in the matching category column and 0 in all others.",
        "icon": "encoding"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "It helps prevent the dummy variable trap (perfect multicollinearity), especially in linear models.",
        "icon": "encoding"
      },
      {
        "text": "Step 1: Start with One-Hot encoded columns.",
        "icon": "encoding"
      },
      {
        "text": "Step 2: Drop one category as a reference (baseline).",
        "icon": "encoding"
      },
      {
        "text": "Step 3: Keep the remaining binary columns.",
        "icon": "encoding"
      },
      {
        "text": "Original categories: Payment Method = [Cash, Card, Bank Transfer].",
        "icon": "encoding"
      },
      {
        "text": "Reference category (dropped): Cash.",
        "icon": "encoding"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "It can introduce bias into model training.",
        "icon": "train"
      },
      {
        "text": "It may reduce prediction accuracy.",
        "icon": "metric"
      },
      {
        "text": "It can cause errors in analysis if not handled properly.",
        "icon": "missing-data"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "MCAR has no systematic pattern.",
        "icon": "missing-data"
      },
      {
        "text": "In practice, MCAR is often an unrealistic assumption in real-world datasets.",
        "icon": "data"
      },
      {
        "text": "Before assuming MCAR, review data collection workflow and consult domain experts.",
        "icon": "data"
      },
      {
        "text": "If MCAR is reasonable, simple imputation (mean/median/mode) can work.",
        "icon": "missing-data"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Standard imputation can be unreliable without additional data or strong domain assumptions.",
        "icon": "missing-data"
      },
      {
        "text": "MNAR has a systematic pattern tied to hidden information.",
        "icon": "neural-net"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "bullets": [
      ...
      {
        "text": "Detect and handle missing values.",
        "icon": "missing-data"
      },
      {
        "text": "Encode categorical features into numerical form.",
        "icon": "encoding"
      },
      {
      ...
      {
        "text": "Scale numerical features when needed.",
        "icon": "scaling"
      }
    ],
