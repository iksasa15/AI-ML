...
export const slides = [
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "b_1",
          "Slope: expected change in y when x increases by 1 unit."
        ]
      ]
    },
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Slope (b_1 = 5): each extra study hour increases predicted score by 5 points.",
            "icon": "target"
          },
          {
            "text": "Intercept (b_0 = 40): if study hours are 0, predicted score is 40.",
            "icon": "target"
          }
        ]
      }
    ...
    "speakerNote": "The regression line is the best-fit line that minimizes prediction errors.",
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Actual value: y_i",
        "icon": "regression"
      },
      {
        "text": "Predicted value: \\(\\hat{y}_i\\)",
        "icon": "target"
      },
      {
        "text": "Residual error: \\(e_i = y_i - \\hat{y}_i\\)",
        "icon": "regression"
      }
    ],
    ...
    "speakerNote": "Squared errors make all errors positive, penalize large errors, and provide a clear optimization objective.",
    "titleIcon": "regression",
    "conceptAnimation": "gradient-descent"
  },
  {
    ...
    "bullets": [
      {
        "text": "Purpose: predict the target variable y using multiple input factors.",
        "icon": "target"
      },
      {
        "text": "Compared with simple regression, it models more realistic multi-factor scenarios.",
        "icon": "regression"
      }
    ],
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "For each additional 1 m^2, price increases by 2.5 (holding other variables constant).",
            "icon": "regression"
          },
          {
            "text": "For each additional bedroom, price increases by 15 (holding other variables constant).",
            "icon": "regression"
          }
        ]
      }
  ...
  },
  {
    ...
    "imageUrls": [
      "/assets/plots/slide-22-1.png",
      "/assets/plots/slide-22-2.png"
    ],
    ...
    "bullets": [
      {
        "text": "Larger R^2 means better explanatory power.",
        "icon": "regression"
      },
      {
        "text": "R^2 = 1 means perfect fit; R^2 = 0 means mean-level prediction performance.",
        "icon": "target"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Adjusted R^2 penalizes unnecessary predictors.",
        "icon": "target"
      },
      {
        "text": "It is usually a better metric for comparing models with different numbers of predictors.",
        "icon": "metric"
      }
    ],
    "table": {
    ...
    "speakerNote": "Model B looks better by R^2, but Adjusted R^2 shows extra variables are likely not helpful.",
    "titleIcon": "regression"
  },
  {
    ...
    "speakerNote": "Explain \"Assumptions of Linear Regression (Overview)\": Linear regression is most reliable when core assumptions are approximately satisfied.",
    "titleIcon": "regression"
  },
  {
    "title": "Assumptions with Practical Examples",
    "imageUrls": [
      "/assets/plots/slide-25-1.png"
    ],
    "table": {
      "headers": [
        "Assumption",
    ...
    "speakerNote": "If one assumption is violated, use transformations, robust methods, feature engineering, or a different model.",
    "titleIcon": "idea"
  },
  {
    ...
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Coefficients become unstable.",
            "icon": "encoding"
          },
          {
            "text": "Interpretation becomes unreliable.",
            "icon": "encoding"
          },
          {
            "text": "Statistical tests may be misleading.",
            "icon": "test"
          }
        ]
      }
    ],
    "speakerNote": "Explain \"Dummy Variables and Dummy Variable Trap\": Categorical variables are converted into binary columns (0/1).",
    "titleIcon": "encoding",
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "If we drop California, then D_1 = 1 means New York and D_1 = 0 means California baseline.",
        "icon": "encoding"
      },
      {
        "text": "This keeps category information while avoiding multicollinearity.",
        "icon": "regression"
      }
    ],
    "table": {
  ...
  },
  {
    ...
    "speakerNote": "Explain \"Building a Regression Model\": Model-building methods select the most relevant predictors to balance simplicity, interpretability, and predictive accur…",
    "titleIcon": "regression"
  },
  {
    ...
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Set significance level (e.g., SL = 0.05).",
            "icon": "model"
          },
          {
            "text": "Fit model with all predictors.",
            "icon": "model"
          },
          {
            "text": "Remove highest p-value if p > SL.",
            "icon": "model"
          },
          {
            "text": "Refit and repeat.",
            "icon": "model"
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "text": "Start with no predictors.",
            "icon": "target"
          },
          {
            "text": "Add variable with lowest p-value below SL.",
            "icon": "model"
          },
          {
            "text": "Continue one-by-one.",
            "icon": "model"
          },
          {
            "text": "Stop when no variable qualifies.",
            "icon": "model"
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "text": "Add significant variables and remove non-significant ones each iteration.",
            "icon": "model"
          }
        ]
      }
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "1",
          "highest p-value: x_4 = 0.42",
          "Remove x_4"
        ],
        [
          "2",
          "highest p-value: x_3 = 0.11",
          "Remove x_3"
        ],
        [
          "Final",
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "If p < alpha: reject H_0 (statistically significant).",
        "icon": "idea"
      },
      {
        "text": "If p >= alpha: fail to reject H_0.",
        "icon": "idea"
      }
    ],
    "formula": "0.03 < 0.05 \\Rightarrow \\text{Reject } H_0",
    "note": "So the predictor is considered significant at the 5% level.",
    "speakerNote": "So the predictor is considered significant at the 5% level.",
    "titleIcon": "idea"
  },
  {
    ...
    "tables": [
      ...
      },
      {
        ...
        "rows": [
          ...
          [
            "General modeling and reporting",
            "0.05"
          ],
          [
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Linear regression: y = b_0 + b_1x",
        "icon": "regression"
      },
      {
        "text": "Polynomial regression: y = b_0 + b_1x + b_2x^2 + b_3x^3 + ...",
        "icon": "regression"
      },
      {
        "text": "It is still linear in parameters because coefficients remain linear.",
        "icon": "regression"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      ...
      {
        "text": "Sales and economic trends",
        "icon": "regression"
      },
      {
        "text": "Rainfall vs crop yield relationships",
        "icon": "regression"
      },
      {
        "text": "Curved or U-shaped data is often underfit by a straight line.",
        "icon": "data"
      }
    ],
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        [
          "1",
          "Start with input feature x"
        ],
        [
          "2",
          "Create transformed terms: x^2, x^3, ..."
        ],
        [
          "3",
        ...
        [
          "4",
          "Estimate coefficients (b_0, b_1, b_2, ...)"
        ],
        [
          "5",
          "Use the fitted equation to predict y"
        ]
      ]
    },
    "formula": "y = b_0 + b_1x + b_2x^2 + \\cdots + b_dx^d",
    "note": "d is the polynomial degree.",
    "speakerNote": "d is the polynomial degree.",
    "titleIcon": "regression"
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Too high",
          "Overfitting (fits noise, weak generalization)"
        ],
        [
          "Balanced degree",
    ...
    "bullets": [
      ...
      {
        "text": "Compare adjusted R^2.",
        "icon": "regression"
      },
      {
        "text": "Compare validation/test error.",
        "icon": "test"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Data shows clear curved trends.",
        "icon": "data"
      },
      {
        "text": "You need more flexibility than a straight line.",
        "icon": "regression"
      },
      {
        "text": "You still want interpretable behavior.",
        "icon": "regression"
      }
    ],
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Forecasting demand and sales trends",
            "icon": "regression"
          },
          {
            "text": "Environmental modeling (rainfall vs yield)",
            "icon": "model"
          },
          {
            "text": "Medical progression patterns",
            "icon": "regression"
          },
          {
            "text": "Engineering curves (stress-strain relationships)",
            "icon": "train"
          }
        ]
      }
  ...
  },
  {
    ...
    "speakerNote": "Use polynomial regression as a baseline, then compare with alternatives as complexity grows.",
    "titleIcon": "regression"
  },
  {
    ...
    "imageUrls": [
      "/assets/plots/slide-39-1.png",
      "/assets/plots/slide-39-2.png"
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Used in disease progression prediction",
        "icon": "target"
      },
      {
        "text": "Used in engineering curves (e.g., stress-strain)",
        "icon": "train"
      },
      {
        "text": "Used in demand and trend forecasting",
        "icon": "regression"
      },
      {
        "text": "SVR uses an epsilon-insensitive zone where small errors are ignored.",
        "icon": "regression"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "\\(\\phi(x)\\) maps input to a (possibly) higher-dimensional space.",
        "icon": "pca"
      },
      {
        "text": "With kernels, we avoid computing \\(\\phi(x)\\) explicitly.",
        "icon": "svm"
      }
    ],
    "sections": [
      {
        ...
        "formula": "\\min_{w,b,\\xi_i,\\xi_i^*} \\; \\frac{1}{2}\\|w\\|^2 + C\\sum_{i=1}^{n}(\\xi_i+\\xi_i^*)"
      },
      {
        "heading": "Constraints",
  ...
  },
  {
    "title": "Why SVR?",
    "imageUrls": [
      "/assets/plots/slide-42-1.png",
      "/assets/plots/slide-42-2.png"
    ],
    "table": {
      "headers": [
        "Aspect",
    ...
    "bullets": [
      {
        "text": "Use feature scaling before SVR.",
        "icon": "scaling"
      },
      {
        "text": "Start with RBF kernel, then tune C, epsilon, and kernel parameters.",
        "icon": "svm"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Captures non-linear relationships.",
        "icon": "regression"
      },
      {
        "text": "Easy to interpret if tree depth is controlled.",
        "icon": "tree"
      },
      {
        "text": "Handles complex feature interactions.",
        "icon": "feature"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Internal node: decision rule (e.g., x <= 4.5).",
        "icon": "regression"
      },
      {
        "text": "Branch: outcome of the rule.",
        "icon": "tree"
      },
      {
        "text": "Leaf node: predicted value (usually region mean).",
        "icon": "tree"
      }
    ],
    "table": {
    ...
    "speakerNote": "This section focuses on the Regression Tree part of CART.",
    "titleIcon": "regression"
  },
  {
    ...
    "sections": [
      ...
      {
        "heading": "Split Score",
        "formula": "\\text{MSE}_{\\text{split}}=\\frac{|S_L|}{|S|}\\text{MSE}(S_L)+\\frac{|S_R|}{|S|}\\text{MSE}(S_R)"
      },
      {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Start with all data at the root node.",
        "icon": "data"
      },
      {
        "text": "Evaluate candidate splits across features.",
        "icon": "test"
      },
      {
        "text": "Compute weighted MSE for each split.",
        "icon": "tree"
      },
      {
        "text": "Select the split with minimum error.",
        "icon": "tree"
      },
      {
        "text": "Repeat recursively on child nodes.",
        "icon": "regression"
      },
      {
        "text": "Stop based on rules (max depth, min samples).",
        "icon": "regression"
      },
      {
        "text": "Predict using leaf mean value.",
        "icon": "tree"
      }
    ],
    "table": {
    ...
    "speakerNote": "These settings reduce overfitting and improve generalization.",
    "titleIcon": "regression",
    "conceptAnimation": "decision-tree-split"
  },
  {
    ...
    "bullets": [
      {
        "text": "Sample training data with bootstrap.",
        "icon": "train"
      },
      {
        "text": "Build many trees on different samples.",
        "icon": "tree"
      },
      {
        "text": "Predict with all trees and average outputs.",
        "icon": "tree"
      }
    ],
    ...
    "speakerNote": "Averaging reduces variance and usually improves generalization.",
    "titleIcon": "regression"
  },
  {
    "title": "Decision Tree vs Random Forest (Regression)",
    "imageUrls": [
      "/assets/plots/slide-48-1.png"
    ],
    "table": {
      "headers": [
        "Aspect",
    ...
    "speakerNote": "Use a single tree for interpretability; use random forest for stronger performance.",
    "titleIcon": "regression",
    "conceptAnimation": "decision-tree-split"
  },
  {
    ...
    "speakerNote": "Evaluate using more than one metric (e.g., RMSE with R^2) for balanced judgment.",
    "titleIcon": "regression"
  },
  {
    ...
    "bullets": [
      {
        "text": "Very low training error",
        "icon": "train"
      },
      {
        "text": "Weak test performance",
        "icon": "test"
      },
      {
        "text": "High variance and unstable predictions",
        "icon": "target"
      }
    ],
    "formula": "\\min_{\\beta} \\; \\underbrace{\\sum_{i=1}^{n}(y_i-\\hat{y}_i)^2}_{\\text{data loss}} + \\lambda \\cdot \\underbrace{\\Omega(\\beta)}_{\\text{penalty}}",
    "note": "Regularization controls complexity by penalizing large coefficients.",
    "speakerNote": "Regularization controls complexity by penalizing large coefficients.",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "formula": "\\min_{\\beta} \\sum_{i=1}^{n}(y_i-\\hat{y}_i)^2 + \\lambda\\sum_{j=1}^{m}\\beta_j^2"
      },
      {
        "heading": "Lasso Regression (L1)",
        "formula": "\\min_{\\beta} \\sum_{i=1}^{n}(y_i-\\hat{y}_i)^2 + \\lambda\\sum_{j=1}^{m}|\\beta_j|"
      },
      {
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Ridge: many small/medium useful features.",
        "icon": "regression"
      },
      {
        "text": "Lasso: only few important features expected.",
        "icon": "regression"
      },
      {
        "text": "Elastic Net: correlated features and need both stability and sparsity.",
        "icon": "feature"
      }
    ],
  ...
  },
  {
    ...
    "speakerNote": "If interpretability is priority: Linear Regression or Decision Tree. If predictive performance is priority: Random Forest.",
    "titleIcon": "regression"
  },
  {
