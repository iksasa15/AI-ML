      ...
      "sections": [
        {
          ...
          "bullets": [
            "Financial news paragraph: group SpaCy entities by label."
          ]
        },
        {
          "heading": "Exercise 2 — Medium",
          "bullets": [
            "Jaccard similarity on lemma sets between two sentences (minus stops)."
          ]
        },
        {
          "heading": "Exercise 3 — Advanced",
          "bullets": [
            "Lightweight event tuples: subject–verb–object + DATE/GPE hooks via deps."
          ]
        }
      ],
