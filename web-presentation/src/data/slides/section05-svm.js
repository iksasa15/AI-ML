/** Auto-split from presentationData — section05-svm */
export const slides = [
  {
    ...
    "bullets": [
      {
        "text": "It maximizes the margin between classes.",
        "icon": "svm"
      },
      {
        "text": "Only support vectors (closest points) determine the boundary.",
        "icon": "embedding"
      },
      {
        "text": "A larger margin usually improves generalization.",
        "icon": "svm"
      }
    ],
    "imageUrls": [
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "New points are classified by the side of the hyperplane they fall on.",
        "icon": "classification"
      },
      {
        "text": "Hard margin: no misclassification allowed (strict separation).",
        "icon": "classification"
      },
      {
        "text": "Soft margin: allows violations for better robustness with overlap/noise.",
        "icon": "svm"
      }
    ],
    ...
    "speakerNote": "Soft-margin SVM adds penalty C to control margin-violation tradeoff.",
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Common in text classification and image-related features.",
        "icon": "classification"
      },
      {
        "text": "Often effective on small-to-medium datasets.",
        "icon": "data"
      }
    ],
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "Avoids explicit high-dimensional mapping in many cases.",
        "icon": "pca"
      },
      {
        "text": "Computes similarity using kernel function K(x_i, x_j).",
        "icon": "svm"
      }
    ],
    "imageUrls": [
  ...
  },
  {
    ...
    "bullets": [
      {
        "text": "If x is close to landmark l_i, similarity is near 1.",
        "icon": "svm"
      },
      {
        "text": "If x is far, similarity approaches 0.",
        "icon": "svm"
      },
      {
        "text": "RBF is a common default for non-linear SVM.",
        "icon": "regression"
      }
    ],
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Large sigma: smoother, wider decision boundary (higher bias).",
            "icon": "svm"
          },
          {
            "text": "Small sigma: tighter, complex boundary (higher variance/overfitting risk).",
            "icon": "warning"
          }
        ]
      }
    ...
    "sections": [
      {
        ...
        "bullets": [
          {
            "text": "Data is high-dimensional or moderately sized.",
            "icon": "pca"
          },
          {
            "text": "Classes are reasonably separable.",
            "icon": "svm"
          },
          {
            "text": "You need non-linear boundaries via kernels.",
            "icon": "regression"
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "text": "Dataset is very large (training can be expensive).",
            "icon": "train"
          },
          {
            "text": "Data is extremely noisy with weak class structure.",
            "icon": "data"
          },
          {
            "text": "Feature count and sample size make kernel matrix too costly.",
            "icon": "svm"
          }
        ]
      }
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Best for",
          "Complex margins, high-dimensional spaces",
    ...
    "speakerNote": "Model choice should be validated with cross-validation and error tradeoff metrics.",
  ...
  },
  {
    ...
    "table": {
      ...
      "rows": [
        ...
        [
          "Kernel",
          "Similarity function",
          "Start with RBF, compare with linear/polynomial"
        ],
        [
          "gamma (RBF)",
    ...
    "speakerNote": "Scale features before SVM, especially for RBF/polynomial kernels.",
    "titleIcon": "svm",
    "conceptAnimation": "svm-margin"
  }
];
