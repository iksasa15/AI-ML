...
|---------|---------|-------|---------|-------|
| Section 1 | opener | The Machine Learning Process | ok | custom |
| Section 1 | math | The Machine Learning Process | ok | custom |
| Section 1 | visual | The Machine Learning Process | ok | custom |
| Section 2 | opener | Regression - Simple Linear Regression | ok | custom |
| Section 2 | math | Regression - Simple Linear Regression | ok | custom |
| Section 2 | visual | Regression - Simple Linear Regression | ok | custom |
| Section 3 | opener | Classification Overview | ok | custom |
| Section 3 | math | Classification Overview | ok | custom |
| Section 3 | visual | Classification Overview | ok | custom |
| Section 4 | opener | Naive Bayes: Bayes' Theorem | ok | custom |
| Section 4 | math | Naive Bayes: Bayes' Theorem | ok | custom |
| Section 4 | visual | Naive Bayes: Bayes' Theorem | ok | custom |
| Section 5 | opener | Support Vector Machine (SVM): Core Idea | ok | custom |
| Section 5 | math | Support Vector Machine (SVM): Core Idea | ok | custom |
| Section 5 | visual | Support Vector Machine (SVM): Core Idea | ok | custom |
| Section 6 | opener | Clustering Overview | ok | custom |
| Section 6 | math | K-Means Clustering: Core Idea | ok | custom |
| Section 6 | visual | Clustering Overview | ok | custom |
| Section 7 | opener | Deep Learning: Introduction | ok | custom |
| Section 7 | math | Deep Learning: Introduction | ok | custom |
| Section 7 | visual | Deep Learning: Introduction | ok | custom |
