...
def build_registry() -> None:
    ...
    # ═══════════ DAY 3 — بيانات وأتمتة ومساعد بتعمّق وفصحى ═══════════
    register(
        "day_divider",
        day="اليوم الثالث",
        title="البيانات والأتمتة والمساعد بتعمّق",
        photo="hero-day3.jpg",
        sessions=[
            ("الوحدة أ", "تحليل البيانات والقرارات", "ساعة ونصف"),
            ("الوحدة ب", "أتمتة المهام وربط الأدوات", "ساعة"),
            ("الوحدة ج", "المساعد المخصص وأمن البيانات", "ساعة ونصف"),
            ("تطبيق ختامي", "مشروع التخرج", "بعد الظهر"),
        ],
    )
    register(
        "cards",
        kicker="اليوم 3  ·  إطار اليوم",
        title="من الوسائط إلى القرار التشغيلي",
        subtitle="سؤال واضح · مصدر · مراجعة بشرية",
        cards=[
            ("جسر يوم 2", "نفس الانضباط: لا مخرج بلا مصدر ومراجعة قبل الاعتماد."),
            ("إسقاط اليوم", "جداول → مسارات أتمتة → مساعد محدود المعرفة."),
        ],
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  نظرة عامة",
        title="مسار اليوم الثالث",
        subtitle="تحليل → أتمتة → مساعد في سلسلة واحدة",
        image="day3-stack.png",
    )

    # ─── الوحدة أ: تحليل البيانات ───
    register(
        "session_open",
        kicker="اليوم 3  ·  الوحدة أ",
        title="تحليل البيانات واتخاذ القرارات",
        duration="ساعة ونصف",
        goal="رفع جدول تدريبي وصياغة أسئلة قوية ثم استخراج توصيات قابلة للمراجعة بمعايير قبول",
        photo="hero-data.jpg",
    )
    register(
        "diagram",
        ...
        subtitle="رفع الملف → سؤال واضح → رسم → توصية قابلة للمراجعة",
    ...
    register(
        ...
        subtitle="مصدر البيانات · حدود التحليل · لا اختلاق أرقام",
        items=[
            "ارفع ملف Excel أو CSV تدريبيًا واطلب ملخص الأعمدة أولًا",
            "افصل الحقائق الواردة في الملف عن التوصيات المقترحة",
    ...
    register(
        "cards",
        kicker="اليوم 3  ·  الوحدة أ",
        title="سؤال تحليل ضعيف مقابل قوي",
        subtitle="نفس الجدول · جودة مختلفة · السبب في صياغة السؤال",
        cards=[
            ("ضعيف", "«حلّل الملف.» — بلا هدف ولا شكل مخرجات ولا قيود."),
            ("قوي", "لخّص الأعمدة، اكتشف الشذوذ، واقترح 3 توصيات تشغيلية من البيانات فقط مع جدول وشكل محدد."),
            ("القاعدة", "يُراجع سؤال التحليل أولًا قبل الحكم على ضعف الأداة."),
        ],
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  الوحدة أ",
        title="مثال أسئلة تحليل مكتملة",
        subtitle="انسخ بعد رفع الملف وعدّل الحقول فقط",
        image="filled-data-questions-example.png",
    )
    register(
        "tools",
        kicker="اليوم 3  ·  الوحدة أ",
        title="اختيار أداة التحليل وفق المهمة",
        subtitle="المعيار: حجم الملف · الرسوم · سياسة الخصوصية",
        tools=[
            ("ChatGPT", "تحليل جداول ورسوم فورية داخل Advanced Data Analysis"),
            ("Claude", "ملفات طويلة وصياغة توصيات منضبطة"),
            ("Google Gemini", "سياق متعدد الوسائط عند الحاجة"),
        ],
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  الوحدة أ",
        title="بوابة تحقق التحليل",
        subtitle="قبل اعتماد التوصيات لصانع القرار",
        image="data-quality-gate.png",
    )
    register(
        "steps",
        kicker="اليوم 3  ·  الوحدة أ",
        title="تطبيق الوحدة أ",
        subtitle="حلّل ملف مبيعات الرياض بمعايير قبول",
        steps=[
            "ارفع ملف مبيعات فرع الرياض التدريبي",
            "نفّذ أسئلة التحليل المكتملة (ملخص · شذوذ · مقارنة · توصيات · رسم)",
            "مرّ على بوابة التحقق: مصدر · لا اختلاق · فصل حقيقة/رأي",
            "معايير القبول: 5 مؤشرات · 3 توصيات من الملف فقط · رسم مفسَّر · جاهز للمراجعة",
        ],
    )
    ...
    register(
        "session_open",
        kicker="اليوم 3  ·  الوحدة ب",
        title="أتمتة المهام وربط الأدوات",
        duration="ساعة",
        goal="تصميم مسار أتمتة واحد بموافقة بشرية ومسار فشل واضح بمعايير قبول",
        photo="hero-automation.jpg",
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  الوحدة ب",
        title="مفهوم مسار العمل الآلي",
        subtitle="إيميل → تلخيص → تخزين → مسودة رد للموافقة",
        image="automation-flow.png",
    )
    register(
        "bullets",
        kicker="اليوم 3  ·  الوحدة ب",
        title="محفّز ثم ذكاء ثم إجراء",
        subtitle="ابدأ بمسار واحد بسيط قبل التوسيع",
        items=[
            "المحفّز: إيميل جديد · نموذج · رسالة Slack — حدّده بدقة",
    ...
    register(
        "cards",
        kicker="اليوم 3  ·  الوحدة ب",
        title="مسار ضعيف مقابل مسار قوي",
        subtitle="الموافقة البشرية جزء من التصميم لا إضافة لاحقة",
        cards=[
            ("ضعيف", "«أتمِت الرد على العملاء.» — بلا محفّز ولا مسار فشل ولا موافقة."),
            ("قوي", "إيميل وارد → تلخيص → صف في جدول → مسودة رد تحتاج موافقة قبل الإرسال."),
            ("بعد التصميم", "سجّل المسار في مستند قصير للفريق قبل التشغيل."),
        ],
    )
    register(
        "tools",
        kicker="اليوم 3  ·  الوحدة ب",
        title="منصات الأتمتة وفق المهمة",
        tools=[
    ...
    register(
        ...
        plain=True,
        items=[
            "ما المحفّز بالضبط؟ (إيميل جديد / نموذج / رسالة Slack)",
            "هل توجد بيانات حسّاسة يجب حجبها قبل إرسالها للنموذج؟",
            "ما مسار الفشل؟ تنبيه بشري عند خطأ أو نقص بيانات",
            "هل الرد النهائي يحتاج موافقة بشرية قبل الإرسال؟",
            "هل سُجّل المسار في مستند بسيط للفريق؟",
        ],
    )
    register(
        "steps",
        kicker="اليوم 3  ·  الوحدة ب",
        title="تطبيق الوحدة ب",
        subtitle="صمّم مسارًا واحدًا بمعايير قبول",
        steps=[
            "اختر محفّزًا واحدًا من عملك اليومي",
            "ارسم المسار: محفّز → ذكاء → إجراء → موافقة بشرية",
            "حدّد مسار الفشل والتنبيه",
            "معايير القبول: محفّز واضح · موافقة قبل الإرسال · مسار فشل · موثّق للفريق",
        ],
    )

    # ─── الوحدة ج: المساعد المخصص ───
    register(
        "session_open",
        kicker="اليوم 3  ·  الوحدة ج",
        title="بناء مساعد مخصص وأمن البيانات",
        duration="ساعة ونصف",
        goal="بناء مساعد محدود المعرفة بملفات معتمدة واختبار نشر بمعايير قبول",
        photo="hero-team.jpg",
    )
    register(
        "cards",
        kicker="اليوم 3  ·  الوحدة ج",
        title="حدود المساعد المخصص",
        subtitle="يُسرّع الروتين ويُبقي القرار للفريق",
        cards=[
            ("نطاق المعرفة", "أجب من الملفات المعتمدة فقط؛ خارج النطاق قل: لا أعرف."),
            ("التحويل للإنسان", "حدّد صراحة متى تُحال المسألة لمسؤول بشري."),
            ("النشر", "لا يُنشر المساعد قبل اختبار بخمس أسئلة حقيقية."),
        ],
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  الوحدة ج",
        title="خطوات بناء المساعد المخصص",
        subtitle="الهدف · الملفات · التعليمات · الاختبار",
        image="gpt-builder-steps.png",
    )
    register(
        "steps",
        kicker="اليوم 3  ·  الوحدة ج",
        title="تفاصيل بناء المساعد للنسخ",
        subtitle="نفّذ بالترتيب",
        steps=[
            "حدّد الهدف: لمن يخدم المساعد وما المهام المسموحة",
            "ارفع الملفات الداخلية المعتمدة فقط (سياسات / أدلة / أسعار عامة)",
            "اكتب تعليمات واضحة: النبرة، الشكل، ومتى يقول لا أعرف",
            "اختبر بخمس أسئلة حقيقية وعدّل التعليمات قبل النشر",
        ],
    )
    register(
        "diagram",
        ...
        subtitle="قواعد لا تُتجاوز في بيئة العمل",
        image="ethics-security.png",
    )
    register(
        "bullets",
        kicker="اليوم 3  ·  الوحدة ج",
        title="قواعد أمن البيانات عمليًا",
        subtitle="ضوابط إلزامية قبل الرفع والنشر",
        items=[
            "ملكية المحتوى المولَّد وسياسات الاستخدام المؤسسي",
            "عدم رفع بيانات سرية إلى أدوات غير معتمدة",
            "التحقق البشري قبل نشر أو إرسال مخرجات حسّاسة",
    ...
    register(
        "tools",
        kicker="اليوم 3  ·  الوحدة ج",
        title="أدوات بناء المساعد وفق المهمة",
        tools=[
    ...
    register(
        ...
        kicker="اليوم 3  ·  الوحدة ج",
        title="تطبيق الوحدة ج",
        subtitle="اختبر المساعد بمعايير نشر",
        steps=[
            "ابنِ مساعدًا بتعليمات محدودة وملف تدريبي واحد على الأقل",
    ...
    # ─── تطبيق ختامي: مشروع التخرج ───
    register(
        "diagram",
        kicker="اليوم 3  ·  تطبيق ختامي",
        title="مشروع التخرج النهائي",
        subtitle="فرق مصغّرة وحل متكامل من مهارات الأيام الثلاثة",
        image="capstone-project.png",
    )
    register(
        "diagram",
        kicker="اليوم 3  ·  تطبيق ختامي",
        title="بوابة جودة المشروع",
        subtitle="أوامر · وسائط · بيانات/أتمتة/مساعد — ثم مراجعة بشرية",
        image="capstone-quality-gate.png",
    )
    register(
        "cards",
        kicker="اليوم 3  ·  تطبيق ختامي",
        title="سيناريوهات جاهزة للاختيار",
        subtitle="اختر مشكلة عمل واحدة وابدأ",
        cards=[
            ("مبيعات", "تلخيص استفسارات العملاء + مسودة رد + جدول متابعة."),
            ("موارد بشرية", "تلخيص سياسة داخلية + أسئلة شائعة عبر مساعد مخصص."),
    ...
    register(
        "steps",
        kicker="اليوم 3  ·  تطبيق ختامي",
        title="مخرجات المشروع ومعايير قبول الفريق",
        steps=[
            ...
            "معايير القبول: مشكلة واضحة · مخرج واحد · مراجعة بشرية · قابل للتجربة غدًا",
        ],
    )
    register(
        "cards",
        ...
        cards=[
            ("الفائدة (40%)", "هل يحل مشكلة عمل حقيقية ويوفّر وقتًا واضحًا؟"),
            ("الجودة (30%)", "دقة المحتوى، وضوح المخرجات، واتساق الهوية."),
            ("قابلية التطبيق (30%)", "هل يمكن تشغيله غدًا بحسابات وأدوات متاحة؟"),
        ],
    )
    ...
    register(
        "cards",
        kicker="اليوم 3  ·  ختام",
        title="خلاصة اليوم الثالث",
        subtitle="ثبّت العادة قبل العودة للعمل",
        cards=[
            ("اسأل البيانات", "ارفع جدولًا واطلب ملخصًا + شذوذًا + توصيات من الملف فقط."),
            ("أتمِت بحذر", "مسار واحد بسيط مع موافقة بشرية على الرد."),
            ("مساعد محدود", "تعليمات واضحة وملفات معتمدة وقل لا أعرف عند النقص."),
        ],
    )
    register(
        "bullets",
        kicker="اليوم 3  ·  ختام",
        title="خطة 7 أيام بعد الورشة",
        subtitle="ماذا تطبّق عند الرجوع للعمل",
        items=[
            "اليوم 1–2: ثبّت قالب أمر احترافي لمهامك المتكررة",
            "اليوم 3–4: أنتج حزمة وسائط واحدة لحملة أو منتج",
            "اليوم 5: حلّل ملفًا جدوليًا حقيقيًا واكتب 3 توصيات",
            "اليوم 6: ابنِ مسار أتمتة واحدًا أو مساعدًا بسيطًا",
            "اليوم 7: راجع النتائج مع زميلك وحدّث ملف القوالب الشخصي",
        ],
    )
    register(
        "linkedin_qr",
    ...
    register(
        ...
        tools=[
            ...
            ("HeyGen · Zapier / Make · GPT Builder", "فيديو وأتمتة ومساعد مخصص"),
        ],
    )
    register("closing")
