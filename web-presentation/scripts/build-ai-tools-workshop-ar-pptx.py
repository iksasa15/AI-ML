...
def build_registry() -> None:
    ...
    register(
        ...
        title="أهداف الورشة",
        subtitle="ما الذي سيخرج به المتدرب في ثلاثة أيام؟",
        items=[
    ...
    register(
        ...
        kicker="اليوم 1  ·  تطبيق عملي",
        title="خطوات التمرين",
        subtitle="يُعطى كل متدرب ملف تقرير PDF",
        steps=[
    ...
    register(
        ...
        cards=[
            ...
            ("واجب قصير", "صغ امرا واحدا قويا لمهمة حقيقية من عملك وارسالها غدا."),
        ],
    )
    register(
        "bullets",
        ...
        subtitle="ما يجب ان يملكه المتدرب قبل المغادرة",
        items=[
            ...
            "امر واحد جاهز لمهمة عمل حقيقية (الواجب)",
        ],
    )
    ...
    register(
        ...
        subtitle="درجات واضحة للمدرب والفرق",
        cards=[
    ...
    register(
        "cards",
        kicker="التنظيم  ·  التجهيزات",
        title="ملاحظات لتنظيم القاعة",
        subtitle="قبل بدء الورشة — لتفادي إضاعة الوقت",
        cards=[
            ("رابط سحابي مسبق", "Google Drive أو Notion: روابط الأدوات + Cheatsheet للأوامر."),
            ("حسابات جاهزة", "فتح الحسابات المجانية على الأدوات الأساسية قبل اليوم الأول."),
            ("ملف التمرين", "توزيع PDF التمرين الإداري وبيانات Excel التجريبية مسبقًا."),
        ],
    )
    register(
        "bullets",
        ...
        items=[
            "إنترنت مستقر وشاشات عرض واضحة",
            "سماعة/ميكروفون للجلسات التي تتضمن فيديو وصوت",
            "وقت احتياطي قصير بين الجلسات لتفعيل الحسابات الطارئة",
            "قناة دعم سريعة (WhatsApp/Slack) لأسئلة الأدوات أثناء التطبيق",
        ],
    )
    register(
        "cards",
        kicker="التنظيم  ·  التجهيزات",
        title="محتوى الرابط السحابي المقترح",
        subtitle="ما يوزع على المشتركين قبل الورشة",
        cards=[
            ("روابط الادوات", "ChatGPT, Claude, Gemini, Perplexity, Midjourney, Gamma, HeyGen, Zapier."),
            ("Cheatsheet", "قوالب الاوامر + هيكل الصورة + سكربت الفيديو + اسئلة التحليل."),
            ("ملفات التمرين", "PDF اداري + Excel تجريبي + نموذج تقييم المشروع."),
        ],
    )
    register("closing")
